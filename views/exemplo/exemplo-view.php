<html>
<head>
<title>Gostariamos de saber a sua opinião sobre o nosso site da Web</title>
...
<p>Gostariamos de saber a sua opiniao sobre o nosso site da Web. Escreva os<br>
seus comentarios neste livro publico de convidados para compartilhar suas<br>
ideias com outros visitantes.</p>
...
<form name="frmComent" action="index.php" OnSubmit="return TestaCampos()"
  method="POST">
	<tr>
	  <th colspan=2>
  		<h2><strong>Adicione seus comentarios</strong></h2>
     </th>
	</tr>
...
<a href="coment.php"><b> Ler comentarios </b></a>
